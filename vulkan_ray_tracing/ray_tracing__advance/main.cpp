...
int main(int argc, char** argv)
{
  ...
  //helloVk.loadModel(nvh::findFile("media/scenes/cornell_box_mirror.obj", defaultSearchPaths, true));
  
  helloVk.loadModel(nvh::findFile("media/scenes/test2.obj", defaultSearchPaths, true),nvmath::translation_mat4(nvmath::vec3f(2.0f, 0.0f, 0.0f)));
  // helloVk.loadModel(nvh::findFile("media/scenes/DamagedHelmet.obj", defaultSearchPaths, true),nvmath::translation_mat4(nvmath::vec3f(0.0f, 2.0f, 0.0f)));
  // helloVk.loadModel(nvh::findFile("media/scenes/Plane.obj", defaultSearchPaths, true));
  //helloVk.loadModel(nvh::findFile("media/scenes/test.obj", defaultSearchPaths, true));
  //helloVk.loadModel(nvh::findFile("media/scenes/3.obj", defaultSearchPaths, true));
