...
void VulkanApp::FillCommandBuffers() {
    ...
    for (size_t i = 0; i < mCommandBuffers.size(); i++) {
        ...
        mCommandBuffer= mCommandBuffers[i];
...
/*void	VulkanApp::InitDefaultRenderPass() {
    if (mRenderPass) {
        vkDestroyRenderPass(mDevice, mRenderPass,0);
    ...
    VkAttachmentDescription attachments[] = {
       VkAttachmentDescription()
            .initialLayout(VkImageLayout::eColorAttachmentOptimal)
            .finalLayout(VkImageLayout::eColorAttachmentOptimal)
...
/*void VulkanApp::init_imgui()
{
    ...
    vkCreateDescriptorPool(mDevice, &pool_info, nullptr, &mimguiDescPool);
